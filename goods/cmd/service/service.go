...
import (
	...
	"flag"
	"fmt"
	endpoint "github.com/GrantZheng/monolith_demo/goods/pkg/endpoint"
	http1 "github.com/GrantZheng/monolith_demo/goods/pkg/http"
...
var fs = flag.NewFlagSet("goods", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("goods", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
