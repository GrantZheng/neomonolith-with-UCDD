...
import (
	...
	"flag"
	"fmt"
	endpoint "github.com/GrantZheng/monolith_demo/message_channel/pkg/endpoint"
	http1 "github.com/GrantZheng/monolith_demo/message_channel/pkg/http"
...
var fs = flag.NewFlagSet("message_channel", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("message_channel", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
