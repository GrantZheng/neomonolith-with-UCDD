...
import (
	...
	http1 "github.com/GrantZheng/monolith_demo/video_content/pkg/http"
...
var fs = flag.NewFlagSet("video_content", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("video_content", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
