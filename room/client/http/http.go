...
import (
	...
	endpoint1 "github.com/GrantZheng/monolith_demo/room/pkg/endpoint"
	http2 "github.com/GrantZheng/monolith_demo/room/pkg/http"
	"github.com/GrantZheng/monolith_demo/room/pkg/service"
...
func New(instance string, options map[string][]http.ClientOption) (service.RoomService, error) {
