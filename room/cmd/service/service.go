...
import (
	...
	http1 "github.com/GrantZheng/monolith_demo/room/pkg/http"
...
var fs = flag.NewFlagSet("room", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("room", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
